...
class GameDB(models.Model):
    ...
    black_player2 = models.ForeignKey(User, on_delete=models.CASCADE, related_name="black_player2", null=True, blank=True)
    ...
    curr_turn = models.CharField(max_length=10, default="white") # values-> "white" and "black" 
    is_bot_mode = models.BooleanField(default=False)
