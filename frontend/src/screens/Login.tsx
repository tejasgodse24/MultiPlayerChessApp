  ...
  return (
    <div className="flex justify-center">
      <div className="pt-8 max-w-screen-md min-h-screen flex flex-col justify-start gap-8 px-4">
        <h1 className="text-3xl md:text-4xl text-green-500 font-medium">
          Enter The Game World
        </h1>
        <div className="flex flex-col gap-6 items-center w-full">
          <form onSubmit={handleSubmit} className="flex flex-col gap-4 w-full max-w-md items-center">
            <input
              className="w-full p-2 text-lg md:text-xl border-2 border-gray-300 focus:border-green-400 focus:outline-none rounded"
              type="text"
              name="email"
            ...
            <button
              disabled={loading}
              className={`w-full md:w-1/2 py-2 px-3 bg-green-500 hover:bg-green-700 text-2xl text-white font-bold rounded`}
            >
              {loading ? "Login..." : "Login"}
            </button>
          </form>
          ...
          <div className="mt-8 flex flex-col gap-4 border-t-2 p-6 w-full items-center">
            <Button
              className="py-2 px-4 text-base w-full md:w-4/5 flex justify-center gap-2 items-center"
              onClick={reachGoogle}
            >
